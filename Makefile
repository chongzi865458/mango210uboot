...
#		cp -f u-boot.bin ../crz_mango210_ginger_dev/image/mango210_uboot.bin
...
mango210_config :	unconfig
	@$(MKCONFIG) $(@:_config=) arm s5pc11x mango210 samsung s5pc110
	@echo "TEXT_BASE = 0x2fd00000" > $(obj)board/samsung/mango210/config.mk

smdkv210single_config :	unconfig
	@$(MKCONFIG) $(@:_config=) arm s5pc11x smdkc110 samsung s5pc110
	@echo "TEXT_BASE = 0x2fe00000" > $(obj)board/samsung/smdkc110/config.mk
