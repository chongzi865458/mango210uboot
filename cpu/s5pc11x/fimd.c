...
void LCD_Initialize_LB070WV6(void)
{
	u32 uFbAddr = CFG_LCD_FBUFFER;
...
//	LCD_setfgcolor(0x0);
	...
	Outp32(0xe02000A0, 0x11111111);	//set GPD0 as Backlight
	Outp32(0xe02000A8,0x0);			//set pull-up,down disable
	Outp32(0xe02000A4,(1<<0));

	Outp32(0xE0200080, 0x11111111);	//set GPC1 as LCD_PWREN
	Outp32(0xE0200088,0x0);			//set pull-up,down disable
	Outp32(0xE0200084,(1<<4));

	Outp32(0xf8000004, 0x60);
	Outp32(0xf8000010, ((LCD_VBPD-1)<<16)|((LCD_VFPD-1)<<8)|(LCD_VSPW-1));
	Outp32(0xf8000014, ((LCD_HBPD-1)<<16)|((LCD_HFPD-1)<<8)|(LCD_HSPW-1));
	Outp32(0xf8000170, 0x0);
	Outp32(0xf8000018, ((LCD_HEIGHT-1)<<11)|(LCD_WIDTH-1));
	Outp32(0xf8000000, 0x0);
	Outp32(0xf8000000, 0x190);
	//Outp32(0xf8000000, 0x110);
	Outp32(0xf8000130, 0x20);
	Outp32(0xf8000020, 0x0);
	Outp32(0xf8000024, 0x0);
	Outp32(0xf8000028, 0x0);
	...
	Outp32(0xf8000034, 0x0);
	Outp32(0xf80000a4, uFbAddr + 0x0);
	Outp32(0xf80000d4, uFbAddr + (LCD_WIDTH*LCD_HEIGHT*4));
	Outp32(0xf80000a0, uFbAddr + 0x0);
	Outp32(0xf80000d0, uFbAddr + (LCD_WIDTH*LCD_HEIGHT*4));
	Outp32(0xf80020a0, uFbAddr + 0x0);
	Outp32(0xf80020d0, uFbAddr + (LCD_WIDTH*LCD_HEIGHT*4));
	Outp32(0xf8000100, (LCD_WIDTH*4));
	Outp32(0xf8000020, 0x802c);
	Outp32(0xf8000040, 0x0);
...
{
#if defined(CFG_LCD_TL2796) || defined(CFG_LCD_NONAME1) || defined(CFG_LCD_LB070WV6)
	u32 i, j;
