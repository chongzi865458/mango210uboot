...
#define USBD_DOWN_ADDR		(MEMORY_BASE_ADDRESS + 0x1000000)
...
#define CONFIG_DRIVER_SMC911X_BASE	0x88000000
...
#define CFG_PROMPT              "FL210 # "   /* Monitor Command Prompt       */
...
#define CFG_MEMTEST_END		MEMORY_BASE_ADDRESS + 0xFD00000	/* 256 MB in DRAM	*/
...
#define DMC0_TIMING_DATA	0x23240304	// TimingData	CL=5
...
#define DMC1_TIMING_DATA	0x23240304	// TimingData	CL=5
...
/*
 * FLO210 board specific data
 */

#define CONFIG_IDENT_STRING	" for FL210"

/* total memory required by uboot */
#define CFG_UBOOT_SIZE		(3*1024*1024)

 /* base address for uboot */
#define CFG_UBOOT_BASE		CFG_MEMTEST_END

#define CFG_PHY_UBOOT_BASE	CFG_MEMTEST_END
...
//#define MTDPARTS_DEFAULT	"mtdparts=s5pv210-nand:1m(bootloader),5m(recovery),5m(kernel),3m(ramdisk),120m(system),122m(userdata)"
#define MTDPARTS_DEFAULT	"mtdparts=s5pv210-nand:1m(bootloader),5m(recovery),5m(kernel),3m(ramdisk),256m(system),256m(userdata)"
...
/* Fastboot variables */
#define CFG_FASTBOOT_TRANSFER_BUFFER		(MEMORY_BASE_ADDRESS2)
#define CFG_FASTBOOT_TRANSFER_BUFFER_SIZE	(0x10000000)   /* 256MB */
#define CFG_FASTBOOT_ADDR_KERNEL		(MEMORY_BASE_ADDRESS + 0x8000)
#define CFG_FASTBOOT_ADDR_RAMDISK		(MEMORY_BASE_ADDRESS + 0x1000000)
...
#define CONFIG_BOOTCOMMAND	"nand read 20008000 80000 400000"
